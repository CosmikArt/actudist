...
Klugman, Panjer & Willmot, *Loss Models* (5th ed.), Section 6.6.4.

We treat ``m`` (number of trials) as a fixed structural parameter, not as
something the MLE driver will tune; the MLE only fits the success
probability :math:`q`.
"""
