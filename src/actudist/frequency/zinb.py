"""Zero-Inflated Negative Binomial (ZINB) frequency distribution.

Klugman, Panjer & Willmot, *Loss Models* (5th ed.), Chapter 6 (zero-modified
distributions). Mixture of a point mass at 0 and a NegativeBinomial body in
Klugman's :math:`(r,\\beta)` parameterization.
"""
