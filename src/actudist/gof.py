...
Implements Kolmogorov-Smirnov, upper-tail emphasized Anderson-Darling, and
chi-squared tests, plus PP/QQ plot helpers. P-values for KS and AD are
computed via parametric bootstrap so they remain valid when distribution
parameters are estimated from the same sample (the Lilliefors problem).
"""
