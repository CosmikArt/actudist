"""Exponential severity distribution.

Klugman, Panjer & Willmot, *Loss Models: From Data to Decisions* (5th ed.),
Appendix A.2.3.1 (mean parameterization).
"""
