"""Inverse Gaussian (Wald) severity, mean-shape parameterization. CDF in
terms of the standard normal :math:`\\Phi`. See Klugman §A.2.3.8."""
...
class InverseGaussian(SeverityDistribution):
    ...
    The closed-form LEV was validated numerically against
    ``scipy.integrate.quad`` to a relative error of ``1e-13``.
    """
