"""Inverse Paralogistic severity distribution.

Klugman, Panjer & Willmot, *Loss Models* (5th ed.), Appendix A.2.1.6.

Special case of the Inverse Burr family with :math:`\\gamma=\\tau`.
"""
...
class InverseParalogistic(SeverityDistribution):
    ...
    Mean is finite for :math:`\tau>1`. Klugman 5e, Appendix A.2.1.6.
    """
