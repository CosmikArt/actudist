"""Log-Logistic severity distribution.

Klugman, Panjer & Willmot, *Loss Models* (5th ed.), Appendix A.2.1.4.

This is the Burr XII family with :math:`\\alpha=1`; we expose it as a
standalone class to avoid forcing pricing notebooks to fix a parameter.
"""
