"""Transformed Beta, the 4-parameter parent of the Burr family.

Reduces to Burr (tau=1), Inverse Burr (alpha=1), Pareto (gamma=tau=1),
Log-Logistic (alpha=tau=1), Paralogistic (tau=1, gamma=alpha), Inverse
Paralogistic (alpha=1, gamma=tau), and Generalized Pareto (gamma=1).
Identifiability is weak when more than one shape is free; expect wide CIs.
"""
...
class TransformedBeta(SeverityDistribution):
    ...
    Klugman 5e Appendix A.2.1.1; the Burr-family parent.
    """
